      ...
      >
        <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-12 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8 xl:gap-10">
            ...
            <NavLink href="#commande">Précommander</NavLink>
            <NavLink href="#la-carte">La carte</NavLink>
            <NavLink href="#bientot">Événements</NavLink>
            <NavLink href="#notre-histoire">Maison Mayssa</NavLink>
            <NavLink href="#notre-histoire">Contact</NavLink>
            ...
            {isAuthenticated ? (
              ...
              <Button
                ...
                className="ml-2 gap-2 border-mayssa-brown/10 hover:border-mayssa-gold text-mayssa-brown bg-white/50"
              >
                <User size={14} />
                Mon Compte
              </Button>
          ...
          <>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-6 py-8 space-y-2">
                <MobileNavLink href="#" onClick={() => setIsMobileMenuOpen(false)}>Accueil</MobileNavLink>
                <MobileNavLink href="#commande" onClick={() => setIsMobileMenuOpen(false)}>Précommander</MobileNavLink>
                <MobileNavLink href="#la-carte" onClick={() => setIsMobileMenuOpen(false)}>La carte</MobileNavLink>
                <MobileNavLink href="#bientot" onClick={() => setIsMobileMenuOpen(false)}>Événements</MobileNavLink>
                <MobileNavLink href="#notre-histoire" onClick={() => setIsMobileMenuOpen(false)}>Maison Mayssa</MobileNavLink>
