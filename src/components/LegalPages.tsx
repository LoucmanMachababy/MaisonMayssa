...
const FAQ_ITEMS = [
  ...
  { q: "C'est quoi la précommande ?", a: "Trompes l'œil : tu passes ta commande et tu récupères ton gâteau environ 3 jours après (délai de préparation). La date exacte est indiquée dans le formulaire selon les disponibilités. Pâtisseries, cookies, boxes et le reste sont disponibles en permanence (pas de délai fixe)." },
