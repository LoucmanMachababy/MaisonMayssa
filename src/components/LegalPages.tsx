  ...
  return (
    ...
    >
      ...
      <div className="prose prose-sm max-w-none text-mayssa-brown/80 space-y-4">
        ...
        <p>
          <strong>Vos droits</strong> : Vous pouvez demander l’accès, la rectification ou l’effacement de vos données en nous contactant par message (WhatsApp, Instagram, Snapchat) ou par téléphone.
        </p>
  ...
  return (
    ...
    >
      ...
      <div className="prose prose-sm max-w-none text-mayssa-brown/80 space-y-4">
        ...
        <p>
          <strong>Contact</strong> : 06 19 87 10 05 · Instagram : @maison.mayssa74 · Snapchat : mayssasucree74.
        </p>
        <p>
        ...
        <p>
          <strong>Liens externes</strong> : Les liens vers WhatsApp, Instagram, Snapchat ou d’autres sites tiers ne nous engagent pas sur leur contenu.
        </p>
        <p className="text-sm text-mayssa-brown/60">
          Dernière mise à jour : {new Date().toLocaleDateString('fr-FR')}.
        </p>
