    ...
    >
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-red-500">
            <Heart size={16} className={!isEmpty ? 'fill-red-500' : ''} />
      ...
      {isEmpty ? (
        <motion.div
          ...
          className="flex flex-col items-center justify-center py-12 sm:py-16 rounded-3xl bg-white/60 border border-mayssa-brown/5"
        >
