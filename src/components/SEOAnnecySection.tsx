        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4 font-light text-mayssa-brown/70 leading-relaxed text-sm sm:text-base">
              ...
              <p>
                Commandez en ligne et récupérez vos créations en <strong>click &amp; collect à Annecy</strong>, de 18h30 à 2h du matin, pour satisfaire toutes vos envies de desserts artisanaux.
              </p>
              <p>
                Retrouvez-nous à la <strong>galerie marchande du centre commercial Carrefour, 134 avenue de Genève à Annecy</strong> — à deux pas de <strong>Seynod</strong>, <strong>Annecy-le-Vieux</strong> et <strong>Cran-Gevrier</strong>. Une pâtisserie artisanale de proximité au cœur de la <strong>Haute-Savoie (74)</strong>.
              </p>
            </div>
          </div>
