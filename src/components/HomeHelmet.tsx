...
export function HomeHelmet() {
  return (
    <Helmet>
      ...
      <meta
        name="description"
        content="Trompe l'œil Annecy ✦ Maison Mayssa : pâtisseries artisanales trompe l'œil (mangue, pistache, passion, framboise). Brownies, cookies, layer cups. Commande en ligne et click & collect à Annecy (galerie marchande Carrefour, av. de Genève), 7j/7."
      />
      ...
      <meta
        ...
        content="Pâtisseries artisanales qui trompent l'œil et régalent les papilles. Brownies, cookies, layer cups, tiramisus. Click & collect à Annecy (galerie marchande Carrefour, av. de Genève)."
      />
    </Helmet>
  )
}
