      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
            <Link
              to="/"
              className="font-display text-2xl tracking-widest uppercase mb-6 cursor-pointer"
              {...trackAttrs('footer-logo', 'Maison Mayssa', 'footer')}
            >
              Maison Mayssa
            </Link>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-4 text-sm text-mayssa-soft/80 text-center md:text-left">
              <li><Link to="/carte" className="hover:text-mayssa-gold transition-colors cursor-pointer" {...trackAttrs('footer-carte', 'La Carte', 'footer')}>La Carte</Link></li>
              <li><Link to="/evenements" className="hover:text-mayssa-gold transition-colors cursor-pointer" {...trackAttrs('footer-evenements', 'Événements', 'footer')}>Événements</Link></li>
              <li><Link to="/a-propos" className="hover:text-mayssa-gold transition-colors cursor-pointer" {...trackAttrs('footer-a-propos', 'La Maison', 'footer')}>La Maison</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 rounded-full border border-mayssa-soft/20 flex items-center justify-center hover:bg-mayssa-gold hover:border-mayssa-gold transition-all duration-300 cursor-pointer"
                aria-label="Instagram"
                {...trackAttrs('footer-instagram', 'Instagram', 'footer')}
              >
                <Instagram size={18} />
              </a>
              <a 
                ...
                className="w-10 h-10 rounded-full border border-mayssa-soft/20 flex items-center justify-center hover:bg-mayssa-gold hover:border-mayssa-gold transition-all duration-300 cursor-pointer"
                aria-label="TikTok"
                {...trackAttrs('footer-tiktok', 'TikTok', 'footer')}
              >
              ...
              <a 
                ...
                className="w-10 h-10 rounded-full border border-mayssa-soft/20 flex items-center justify-center hover:bg-mayssa-gold hover:border-mayssa-gold transition-all duration-300 cursor-pointer"
                aria-label="Snapchat"
                {...trackAttrs('footer-snapchat', 'Snapchat', 'footer')}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-16 pt-8 border-t border-mayssa-soft/10 flex flex-col md:flex-row items-center justify-between text-xs text-mayssa-soft/40">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-x-6 gap-y-2 mt-4 md:mt-0">
            <Link to="/legal#cgv" className="hover:text-mayssa-soft transition-colors cursor-pointer" {...trackAttrs('footer-cgv', 'CGV', 'footer')}>CGV</Link>
            <Link to="/legal#mentions-legales" className="hover:text-mayssa-soft transition-colors cursor-pointer" {...trackAttrs('footer-mentions', 'Mentions légales', 'footer')}>Mentions légales</Link>
            <Link to="/legal#confidentialite" className="hover:text-mayssa-soft transition-colors cursor-pointer" {...trackAttrs('footer-confidentialite', 'Confidentialité', 'footer')}>Confidentialité</Link>
            <Link to="/legal#accessibilite" className="hover:text-mayssa-soft transition-colors cursor-pointer" {...trackAttrs('footer-accessibilite', 'Accessibilité', 'footer')}>Accessibilité</Link>
            <Link to="/faq" className="hover:text-mayssa-soft transition-colors cursor-pointer" {...trackAttrs('footer-faq', 'FAQ', 'footer')}>FAQ</Link>
            <Link to="/contact" className="hover:text-mayssa-soft transition-colors cursor-pointer" {...trackAttrs('footer-contact-legal', 'Contact', 'footer')}>Contact</Link>
          </div>
        </div>
      </div>
    </footer>
